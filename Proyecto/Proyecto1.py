...
for i in range(20):
    if jugador1.pos()>= (200,200):
        ...
        turno1= input("presione entrer para avanzar la totuga verde")
        turno1 =random.choice(dado)
        print("tu numero es", turno1, "Avanzas: ",turno1*20)
        jugador1.pendown()
        jugador1.forward(20*turno1)

        turno2= input("presione entrer para avanzar la totuga Azul")
        turno2 =random.choice(dado)
        print("tu numero es", turno2, "Avanzas: ",turno2*20)
        jugador2.pendown()
        jugador2.forward(20*turno1)
